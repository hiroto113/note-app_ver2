...
describe('QualityMetricsService', () => {
	...
	describe('calculateTrend', () => {
		it('should calculate upward trend correctly', () => {
			...
			const result = (service as any).calculateTrend('Test Metric', 90, 80);
		...
		it('should calculate downward trend correctly', () => {
			const result = (service as any).calculateTrend('Test Metric', 70, 80);
		...
		it('should identify stable trend for small changes', () => {
			const result = (service as any).calculateTrend('Test Metric', 81, 80);
