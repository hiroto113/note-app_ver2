...
<div class="space-y-3">
	...
	<div class="border border-gray-300 rounded-md overflow-hidden" class:border-red-300={error}>
		{#if viewMode === 'editor'}
			<MarkdownEditor
				bind:this={editorRef}
				bind:value
	...
	{#if viewMode !== 'preview'}
		<div class="text-xs text-gray-500 space-y-1">
			<p>Markdownをサポートしています。ショートカット: <code class="bg-gray-100 px-1 rounded">Ctrl+F</code> 検索</p>
		</div>
	{/if}
</div>