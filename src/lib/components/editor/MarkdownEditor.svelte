...
<div class="space-y-1">
	...
	{#if placeholder && !value}
		<div class="absolute inset-0 pointer-events-none flex items-start pt-3 pl-3 text-gray-400 text-sm">
			{placeholder}
		</div>
	{/if}
